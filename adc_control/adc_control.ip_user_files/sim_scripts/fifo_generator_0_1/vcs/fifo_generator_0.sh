...
#
# Generated by Vivado on Thu Aug 11 12:28:44 -0400 2022
...
# Design libraries
design_libs=(xilinx_vip xpm fifo_generator_v13_2_7 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"C:/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"C:/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_7 $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
