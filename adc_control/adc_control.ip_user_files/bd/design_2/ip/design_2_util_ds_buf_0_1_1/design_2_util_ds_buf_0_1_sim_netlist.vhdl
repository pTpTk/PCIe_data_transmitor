...
-- Date        : Fri Aug  5 12:58:24 2022
-- Host        : DESKTOP-OPS50DH running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/Petzval-PC/Documents/LiteFury/Artix7_PCIe/dso_top_litefury/dso_top_litefury.gen/sources_1/bd/design_2/ip/design_2_util_ds_buf_0_1_1/design_2_util_ds_buf_0_1_sim_netlist.vhdl
...
entity design_2_util_ds_buf_0_1_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of design_2_util_ds_buf_0_1_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of design_2_util_ds_buf_0_1_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of design_2_util_ds_buf_0_1_util_ds_buf : entity is "BUFG";
  attribute C_MODE : string;
  attribute C_MODE of design_2_util_ds_buf_0_1_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of design_2_util_ds_buf_0_1_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of design_2_util_ds_buf_0_1_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of design_2_util_ds_buf_0_1_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of design_2_util_ds_buf_0_1_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_2_util_ds_buf_0_1_util_ds_buf : entity is "util_ds_buf";
end design_2_util_ds_buf_0_1_util_ds_buf;

architecture STRUCTURE of design_2_util_ds_buf_0_1_util_ds_buf is
...
entity design_2_util_ds_buf_0_1 is
  ...
  attribute NotValidForBitStream of design_2_util_ds_buf_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_2_util_ds_buf_0_1 : entity is "design_2_util_ds_buf_0_1,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_2_util_ds_buf_0_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_2_util_ds_buf_0_1 : entity is "util_ds_buf,Vivado 2021.2";
end design_2_util_ds_buf_0_1;

architecture STRUCTURE of design_2_util_ds_buf_0_1 is
  ...
  attribute x_interface_parameter of BUFG_I : signal is "XIL_INTERFACENAME BUFG_I, FREQ_HZ 40000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
  attribute x_interface_info of BUFG_O : signal is "xilinx.com:signal:clock:1.0 BUFG_O CLK";
  attribute x_interface_parameter of BUFG_O : signal is "XIL_INTERFACENAME BUFG_O, FREQ_HZ 40000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
begin
U0: entity work.design_2_util_ds_buf_0_1_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
