...
-- Date        : Wed Aug  3 10:56:01 2022
-- Host        : DESKTOP-OPS50DH running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top design_2_clk_wiz_0 -prefix
--               design_2_clk_wiz_0_ design_2_clk_wiz_0_sim_netlist.vhdl
...
entity design_2_clk_wiz_0_design_2_clk_wiz_0_clk_wiz is
  port (
...
end design_2_clk_wiz_0_design_2_clk_wiz_0_clk_wiz;

architecture STRUCTURE of design_2_clk_wiz_0_design_2_clk_wiz_0_clk_wiz is
...
entity design_2_clk_wiz_0 is
  ...
  attribute NotValidForBitStream of design_2_clk_wiz_0 : entity is true;
end design_2_clk_wiz_0;

architecture STRUCTURE of design_2_clk_wiz_0 is
begin
inst: entity work.design_2_clk_wiz_0_design_2_clk_wiz_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
