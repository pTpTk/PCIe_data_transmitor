...
#
# Generated by Vivado on Fri Aug 05 13:16:14 -0400 2022
...
# Set xvlog options
xvlog_opts="--incr --relax -L xdma_v4_1_14"
...
simulate()
{
  xsim fifo_generator_0 -key {Behavioral:sim_1:Functional:fifo_generator_0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/design_2.protoinst" -log simulate.log
}
